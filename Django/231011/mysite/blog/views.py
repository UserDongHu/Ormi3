...
#     # return HttpResponse(s.replace('{{title}}', data[0]['title']).replace('{{text}}', data[0]['text'])) # 4 (render이 하는 역할. 그래서 내부에서 css나 js를 못읽음)
...
#     # return HttpResponse(header + main + footer) # 5 (templates 상속 방식)
